...
class HomeController extends Controller
{
    public function index()
    {
        ...
        if ($numberallInvoices > 0) {
            ...
            $totalallInvoices = 0;
            $numberpaiedInvoices = 0;
            $totalpaiedInvoices = 0;
            $presentpaiedInvoices = 0;
            $numberunpaiedInvoices = 0;
            $totalunpaiedInvoices = 0;
            $presentunpaiedInvoices = 0;
            $numberpartpaiedInvoices = 0;
            $totalpartpaiedInvoices = 0;
            $presentpartpaiedInvoices = 0;
        }
