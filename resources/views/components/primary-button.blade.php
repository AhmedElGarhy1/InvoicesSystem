<button {{ $attributes->merge(['type' => 'submit',
    'class' => 'inline-flex items-center px-4 py-2  dark:bg-gray-200
    ...
    dark:focus:ring-offset-gray-800 transition ease-in-out duration-150' , 'style'=> 'background-color:#9B4999']) }}>
    {{ $slot }}
</button>
