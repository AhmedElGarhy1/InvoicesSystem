...
<aside class="app-sidebar sidebar-scroll">
    <div class="main-sidebar-header active">
        <a class="desktop-logo logo-light active" href="{{ route('dashboard') }}"><img
                src="{{ URL::asset('assets/img/brand/logoinvoices.png') }}" class="main-logo" alt="logo"></a>
    ...
    <div class="main-sidemenu">
            ...
            <div class="dropdown user-pro-body">
                <div class="">
                    <img alt="user-img" class="avatar avatar-xl brround"
                        src={{ asset(Auth::User()->image) }}><span
        ...
        <ul class="side-menu">
            ...
            @can('الفواتير')
                ...
                <li class="slide">
                    <a class="side-menu__item" data-toggle="slide" href="{{ url('/' . ($page = 'index')) }}"><svg
                    ...
                    <ul class="slide-menu">
                        @can('قائمة الفواتير')
                            <li><a class="slide-item" href="{{ route('invoiceslist') }}">قائمه الفواتير</a></li>
                        @endcan
                        @can('الفواتير المدفوعة')
                            <li><a class="slide-item" href="{{ route('invoicforstate1') }}">الفواتير المدفوعه<invoic
                                        /for/statea>
                                        <invoic /for/stateli>
                        @endcan
                        @can('الفواتير الغير مدفوعة')
                            <li><a class="slide-item" href="{{ route('invoicforstate2') }}">الفواتير الغير مدفوعه</a></li>
                        @endcan
                        @can('الفواتير المدفوعة جزئيا')
                            <li><a class="slide-item" href="{{ route('invoicforstate3') }}">الفواتير المدفوعه جزئيا </a></li>
                        @endcan
                        @can('ارشيف الفواتير')
                            <li><a class="slide-item" href="{{ route('arachaeinvoices') }}">ارشيف الفواتير</a></li>
                        @endcan
                    </ul>
                </li>
            @endcan
            @can('التقارير')
                ...
                <li class="slide">
                    ...
                    <ul class="slide-menu">
                        @can('تقرير الفواتير')
                            <li><a class="slide-item" href="{{ route('reportsinvoice') }}">تقارير الفواتير</a></li>
                        @endcan
                        @can('تقرير العملاء')
                            <li><a class="slide-item" href="{{ route('reportscustomer') }}">تقارير العملاء</a></li>
                        @endcan
                    </ul>
                </li>
            @endcan
                ...
                <li class="slide">
                    ...
                    <ul class="slide-menu">
                        @can('قائمة المستخدمين')
                            <li><a class="slide-item" href="{{ route('listusers') }}">قائمه المستخدمين</a></li>
                        @endcan
                        @can('صلاحيات المستخدمين')
                            <li><a class="slide-item" href="{{ route('listroles') }}">صلاحيات المستخدمين</a></li>
                        @endcan
                    </ul>
                </li>
            @endcan
            @can('الاعدادات')
                ...
                <li class="slide">
                    ...
                    <ul class="slide-menu">
                        @can('الاقسام')
                            <li><a class="slide-item" href="{{ route('sectionslist') }}">الاقسام</a></li>
                        @endcan
                        @can('المنتجات')
                            <li><a class="slide-item" href="{{ route('productlist') }}">المنتجات</a></li>
                        @endcan
                    </ul>
                </li>
            @endcan
